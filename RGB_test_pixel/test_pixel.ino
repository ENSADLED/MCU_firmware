...
ledcWrite(0, gamma28_8b_16b[130]);
delay(200);
ledcWrite(1, gamma28_8b_16b[255]);
delay(200);
ledcWrite(2, gamma28_8b_16b[200]);
delay(200);
ledcWrite(3, gamma28_8b_16b[255]);
delay(200);
ledcWrite(4, gamma28_8b_16b[176]);
delay(200);
ledcWrite(5, gamma28_8b_16b[149]);
delay(200);
ledcWrite(6, gamma28_8b_16b[30]);
delay(200);
ledcWrite(7, gamma28_8b_16b[200]);
delay(200);
ledcWrite(8, gamma28_8b_16b[255]);
delay(200);
